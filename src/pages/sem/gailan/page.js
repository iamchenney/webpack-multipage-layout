...
function ajax(str, name, us) {
  ...
  utils.ajax(apiUrl.getApiUrl('getAccountTwoWeek'), { appid: 'appid', user: 'user', us: us, page: 'page' }).done(function (el) {
    var activeRate = [];
    var days = [];
    var downloadRate = [];
    var totalCost = [];
  ...
  $('.clear').show();
  utils.ajax(apiUrl.getApiUrl('getAccountWeekCost'), { appid: 'appid', user: 'user', us: 'us', page: 'page' }).done(function (el) {
    var arr = [];
    var arr2 = [];
    var arr3 = [];
    if (el.length !== 0) {
...
function upload(str, name, us) {
  ...
  utils.ajax(apiUrl.getApiUrl('getAccountAll'), { appid: 'appid', user: 'user', us: 'us', page: 'page' }).done(function (el) {
    console.log(el);
